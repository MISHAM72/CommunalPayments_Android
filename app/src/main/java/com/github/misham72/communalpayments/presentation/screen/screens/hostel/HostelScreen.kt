...
@Composable
fun HostelScreen(viewModel: HostelViewModel, appContainer: AppContainer) {
    ...
    if (showReceipts) {
        ...
        Column(
            ...
            ServiceTopBar(
                ...
                title = uiState.providerDetails.customServiceName.ifBlank { serviceName(ServiceKeys.HOSTEL) },
