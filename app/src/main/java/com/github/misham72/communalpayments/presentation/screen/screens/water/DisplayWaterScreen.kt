...
fun DisplayWaterScreen(viewModel: WaterViewModel) {
    ...
    Column(
        ...
        ServiceTopBar(title = uiState.customServiceName.ifBlank { stringResource(R.string.service_display_name_water) }, onEditClick = { viewModel.openAccountDialog() }, onShareClick = {
            scope.launch {
