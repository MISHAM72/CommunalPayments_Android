...
import com.github.misham72.communalpayments.logic.Troyka
...
fun DisplayTroykaScreen() {
    ...
    Column(verticalArrangement = Arrangement.spacedBy(16.dp)) {
        ...
        if (newTroykaData != null) {
            val data = newTroykaData ?: return@Column
            Card(modifier = Modifier.fillMaxWidth()) {
                Column(modifier = Modifier.padding(16.dp)) {
                    Text(stringResource(R.string.result_troyka), fontWeight = FontWeight.Bold)
