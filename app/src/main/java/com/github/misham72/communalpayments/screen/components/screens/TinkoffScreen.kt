...
import com.github.misham72.communalpayments.logic.Tinkoff


@Composable
fun DisplayTinkoffScreen() {
    ...
    Column(verticalArrangement = Arrangement.spacedBy(16.dp)) {
        ...
        if (newTinkoffData != null) {
            val data = newTinkoffData ?: return@Column
            Card(modifier = Modifier.fillMaxWidth()) {
                Column(modifier = Modifier.padding(16.dp)) {
                    Text(stringResource(R.string.result_tinkoff), fontWeight = FontWeight.Bold)
