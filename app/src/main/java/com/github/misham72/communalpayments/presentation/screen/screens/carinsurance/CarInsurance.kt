package com.github.misham72.communalpayments.presentation.screen.screens.carinsurance
...
fun DisplayCarInsurance() {
    ...
    Column(
        ...
        if (newOsagoData != null) {
            val data = newOsagoData ?: return@Column
            Card(modifier = Modifier.fillMaxWidth()) {
                Column(modifier = Modifier.padding(16.dp)) {
                    Text(stringResource(R.string.result_osago), fontWeight = FontWeight.Bold)
