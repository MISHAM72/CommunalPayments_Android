...
fun DisplayTroykaScreen(viewModel: TroykaViewModel) {
    ...
    Column(
        ...
        ServiceTopBar(
            ...
            title = uiState.providerDetails.customServiceName.ifBlank { stringResource(R.string.service_display_name_troyka) }, onEditClick = { viewModel.openAccountDialog() }, onShareClick = {
                scope.launch {
                    HistoryExporter.shareSingleHistory(context, TroykaViewModel.SERVICE_KEY)
                }
            },
