...
fun DisplayTroykaScreen(viewModel: TroykaViewModel) {
    ...
    Column(
        ...
        ServiceTopBar(title = uiState.customServiceName.ifBlank { stringResource(R.string.service_display_name_troyka) }, onEditClick = { viewModel.openAccountDialog() }, onShareClick = {
            scope.launch {
