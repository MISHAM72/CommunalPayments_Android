...
class Garbage(private val context: Context) {
    ...
    fun collectGarbageData(): GarbageData {
        return GarbageData(
            ...
            previousPayment = PeriodCalculator.getPreviousPaymentString(1, 25),
            nextPayment = PeriodCalculator.getNextPaymentString(1, 25),
            daysFromPayment = PeriodCalculator.calculateDaysFromPreviousPayment(1, 25),
            daysUntilPayment = PeriodCalculator.calculateDaysToNextPayment(1, 25),
            priceTariff = 100L,
        )
    }
