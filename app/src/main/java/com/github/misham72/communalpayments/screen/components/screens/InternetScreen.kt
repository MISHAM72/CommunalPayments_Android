...
import com.github.misham72.communalpayments.logic.Internet
...
fun DisplayInternetScreen() {
    ...
    Column(verticalArrangement = Arrangement.spacedBy(16.dp)) {
        Button(
            onClick = {
                newInternetData = newIntent.collectInternetData()
                newIntent.saveInternetData(newInternetData ?: return@Button)
        ...
        if (newInternetData != null) {
            val data = newInternetData ?: return@Column
