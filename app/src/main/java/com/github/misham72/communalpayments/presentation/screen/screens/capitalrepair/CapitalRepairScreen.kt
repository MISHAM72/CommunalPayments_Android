...
@Composable
fun CapitalRepairScreen(viewModel: CapitalRepairViewModel, appContainer: AppContainer) {
    ...
    if (showReceipts) {
        ReceiptsScreen(
            serviceKey = CapitalRepairViewModel.SERVICE_KEY,
        ...
        Column(
            ...
            ServiceTopBar(
                title = uiState.providerDetails.customServiceName.ifBlank { serviceName(ServiceKeys.CAPITAL_REPAIR) },
            ...
            OutlinedTextField(
                ...
                label = { Text(stringResource(R.string.area_label)) },
                modifier = Modifier
                    .fillMaxWidth()
                    .heightIn(min = 48.dp),
                singleLine = true,
            ...
            Card(
                ...
                if (result != null) {
                    Column(
                        ...
                        Text(
                            text = stringResource(R.string.result_capital_repair),
                            style = MaterialTheme.typography.titleMedium,
                            fontWeight = FontWeight.Bold
                        )
                        Text(
                            text = stringResource(R.string.area_format, result.area),
                            fontWeight = FontWeight.Bold,
                        )
                        Text(
                            text = stringResource(R.string.tariff_per_sqm, result.tariff),
                        )
                        Text(
