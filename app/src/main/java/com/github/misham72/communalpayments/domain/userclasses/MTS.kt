...
class MTS(private val context: Context) {
    ...
    fun collectMTSData(): MTSData {
        return MTSData(
            ...
            previousPayment = PeriodCalculator.getPreviousPaymentString(1, 23),
            nextPayment = PeriodCalculator.getNextPaymentString(1, 23),
            daysFromPayment = PeriodCalculator.calculateDaysFromPreviousPayment(1, 23),
            daysUntilPayment = PeriodCalculator.calculateDaysToNextPayment(1, 23),
            priceTariff = 905L,
        )
    }
