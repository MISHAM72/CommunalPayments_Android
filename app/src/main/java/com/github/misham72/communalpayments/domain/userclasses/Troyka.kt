...
class Troyka(private val context: Context) {
    ...
    fun collectTroykaData(): TroykaData {
        return TroykaData(
            ...
            previousPayment = PeriodCalculator.getPreviousPaymentString(12, 24),
            nextPayment = PeriodCalculator.getNextPaymentString(12, 24),
            daysFromPayment = PeriodCalculator.calculateDaysFromPreviousPayment(12, 24),
            daysUntilPayment = PeriodCalculator.calculateDaysToNextPayment(12, 24),
            priceTariff = 16400L,
        )
    }
